<template>
  <div class="flex h-screen w-full max-w-2xl flex-col gap-4 bg-gray-900 p-4 text-white md:flex-row">
    <div
    ...
    <div
      class="relative flex aspect-square w-full items-center justify-center rounded-lg bg-gray-700 p-4 shadow-inner"
    >
      <MemoryCanvas
        :seed="gameStore.seed"
